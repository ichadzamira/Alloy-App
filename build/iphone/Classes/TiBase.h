...
// in simulator we redefine to format for Camera Developer console
...
{\
	NSString * exceptionName = [@"org.camera." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.camera";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICameraNativeItemNone = -1, 
	UICameraNativeItemSpinner = -2,
	UICameraNativeItemProgressBar = -3,
	
	UICameraNativeItemSlider = -4,
	UICameraNativeItemSwitch = -5,
	UICameraNativeItemMultiButton = -6,
	UICameraNativeItemSegmented = -7,
	
	UICameraNativeItemTextView = -8,
	UICameraNativeItemTextField = -9,
	UICameraNativeItemSearchBar = -10,
	
	UICameraNativeItemPicker = -11,
	UICameraNativeItemDatePicker = -12,
	
	UICameraNativeItemInfoLight = -13,
	UICameraNativeItemInfoDark = -14,
	
	UICameraNativeItemDisclosure = -15,
	
	UICameraNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Camera instances of
